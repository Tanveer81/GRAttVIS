...
from grattvis import add_genvis_config
...
def get_parser():
    parser = argparse.ArgumentParser(description="grattvis demo for builtin configs")
    parser.add_argument(
        "--config-file",
        default="configs/grattvis/youtubevis_2019/grattvis_R50_bs8.yaml",
        metavar="FILE",
